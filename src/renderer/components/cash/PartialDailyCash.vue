...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      realCash () {
        return parseFloat(this.subCard) + parseFloat(this.subCash) + parseFloat(this.cash.init_amount) - parseFloat(this.debitos) - parseFloat(this.cash.total_home) + parseFloat(this.totalInFavor)
      },
      onlyCash () {
